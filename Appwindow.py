...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.frame.setGeometry(
            QtCore.QRect(QtCore.QPoint(0, 0), QtCore.QPoint(self.width, self.height))
        )
    ...
    def BestMoveButton(self):
        ...
        self.button.setGeometry(
            QtCore.QRect(
                QtCore.QPoint(
                    round(0.2 * self.width) + 480, round(0.05 * self.height) + 40
                ),
                QtCore.QPoint(
                    round(0.2 * self.width) + 600, round(0.05 * self.height) + 90
                ),
            )
        )
    ...
    def BoardSVG(self):
        ...
        self.boardSvg.setGeometry(
            QtCore.QRect(
                QtCore.QPoint(round(0.2 * self.width), round(0.05 * self.height) + 100),
                QtCore.QPoint(
                    round(0.2 * self.width) + 600, round(0.05 * self.height) + 700
                ),
            )
        )
        self.boardSvg.show()
    ...
    def EvalBar(self):
        ...
        self.bar.setGeometry(
            QtCore.QRect(
                QtCore.QPoint(round(0.05 * self.width), round(0.05 * self.height)),
    ...
    def EvalLabel(self):
        ...
        self.label.setGeometry(
            QtCore.QRect(
                QtCore.QPoint(round(0.05 * self.width) + 60, round(0.05 * self.height)),
                QtCore.QPoint(
                    round(0.05 * self.width) + 200, round(0.05 * self.height) + 50
                ),
            )
        )
        # set Font
